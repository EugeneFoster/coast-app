    ...
    <main className="mt-4 md:mt-5">
      ...
      <form action="/inventory" className="mt-4 grid gap-2 md:mt-5 md:grid-cols-[minmax(260px,1fr)_auto_auto_auto_auto]">
        ...
        <div className="hidden overflow-hidden rounded-[4px] border border-rule md:flex">
          <span className="flex h-10 w-10 items-center justify-center bg-ink text-bone"><DesignIcon name="list" size={16} /></span>
          <span className="flex h-10 w-10 items-center justify-center bg-paper text-graph"><DesignIcon name="grid" size={16} /></span>
        </div>
      </form>
